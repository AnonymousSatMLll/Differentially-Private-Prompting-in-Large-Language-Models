...
# Dataloader
train_loader = DataLoader(balanced_dataset, batch_size=40, shuffle=True)
...
print(f"\n Test Accuracy after 4 epochs for one-phase normal clipping  with epsilon 2 is : {accuracy * 100:.2f}%")
